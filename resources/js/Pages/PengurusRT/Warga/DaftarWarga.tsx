...
export default function DaftarWarga({ keluarga, wargas, wilayah, options }: Props) {
    ...
    const submit = (e: React.FormEvent) => {
        ...
        if (isEditMode && selectedWarga) {
            form.post(route('pengurus-rt.warga.update', selectedWarga.id), {
                preserveScroll: true,
                onSuccess: () => {
                    closeModals();
            ...
            form.post(route('pengurus-rt.warga.store'), {
                preserveScroll: true,
                onSuccess: () => {
                    closeModals();
    ...
    const deleteWarga = () => {
        ...
        form.delete(route('pengurus-rt.warga.destroy', selectedWarga.id), {
            preserveScroll: true,
            onSuccess: () => {
                closeModals();
    ...
    return (
        <PengurusRTLayout title="Detail Keluarga & Anggota">
            ...
            <div className="mb-4">
                <Link href={route('pengurus-rt.keluarga.index')} className="text-amber-600 hover:text-amber-700 text-sm font-medium flex items-center gap-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
                        ...
                        <div className="md:col-span-3 pt-4 mt-1 border-t border-gray-100">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4">
                                ...
                                {/* Mulai Melahirkan */}
                                <div className="p-3 bg-gray-50 border border-gray-100 rounded-xl shadow-sm">
                                    <p className="text-[11px] font-bold text-purple-600 uppercase tracking-wider mb-2">Mulai Melahirkan</p>
                                    <div className="space-y-2.5">
                                        <div>
