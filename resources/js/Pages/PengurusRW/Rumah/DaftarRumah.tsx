...
export default function DaftarRumah({ rumahs, eksporUrl }: { rumahs: RumahItem[], eksporUrl: string }) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('pengurus-rw.rumah.store'), {
    ...
    const submitEdit: FormEventHandler = (e) => {
        ...
        editForm.post(route('pengurus-rw.rumah.update', selectedRumah.id), {
    ...
    const confirmDelete = () => {
        if (!selectedRumah) return;
        router.delete(route('pengurus-rw.rumah.destroy', selectedRumah.id), {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="md:col-span-2 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <TextInput id="rt" type="text" className="mt-1 block w-full py-1.5 px-3 text-sm" value={formData.rt} onChange={e => setFormData('rt', e.target.value)} placeholder="Contoh: 001" required />
    ...
    return (
        <PengurusRWLayout title="Data Rumah">
